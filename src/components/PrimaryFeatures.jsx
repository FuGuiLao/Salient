...
export function PrimaryFeatures() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-zinc-600 pt-20 pb-28 sm:py-32"
    >
      <Image
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          <p className="mt-6 text-lg tracking-tight text-zinc-100">
                      ...
                      <h3>
                        <Tab
                          className={clsx(
                            ...
                            selectedIndex === featureIndex
                              ? 'text-zinc-600 lg:text-white'
                              : 'text-zinc-100 hover:text-white lg:text-white'
                          )}
                        >
              ...
              <Tab.Panels className="lg:col-span-7">
                {features.map((feature) => (
                  <Tab.Panel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-[45rem] overflow-hidden rounded-xl bg-zinc-50 shadow-xl shadow-zinc-900/20 sm:w-auto lg:mt-0 lg:w-[67.8125rem]">
                      <Image
                        className="w-full"
                        src={feature.image}
                        alt=""
